...
namespace MGL
{
    internal class CheckGithubFooClient
    {
        #region -- Проверка последней версии Foo's Client на Github --
        public string CheckLatestRelease()
        {
            ...
            using (WebClient client = new WebClient())
            {
                ...
                string api_url = "https://api.github.com/repos/mindustry-antigrief/mindustry-client-v7-builds/releases/latest";
